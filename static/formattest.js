(function (f, g) {
    ...
    function Oa() {
        if (.35 > h)L = null; else {
            ...
            L = QUAD.init({minX: a - (e + 100), minY: b - (e + 100), maxX: c + (e + 100), maxY: d + (e + 100)});
            for (p = 0; p < n.length; p++)if (a = n[p], a.shouldRender())for (b = 0; b < a.points.length; ++b)L.insert(a.points[b])
        }
    }
    ...
    function ma() {
        ...
        g.ajax(F + "//m.agar.io/", {
            ...
            }, dataType: "text", method: "POST", cache: !1, crossDomain: !0, data: u + M || "?"
        })
    }
    ...
    function Ea(a) {
        ...
        v = w = null;
        H = 0;
        if (typeof window.custom_ip != 'undefined')
        	a = 'ws://' + window.custom_ip;  
      	window.custom_ip = a.substr(5);
    ...
    function Ta(a) {
        ...
        for (var d = a.getUint16(c, !0), c = c + 2, e = 0; e < d; ++e) {
            var p =
                y[a.getUint32(c, !0)], f = y[a.getUint32(c + 4, !0)], c = c + 8;
    ...
    function Fa() {
        if (ra() && null != D) {
            var a = new ArrayBuffer(1 + 2 * D.length), b = new DataView(a);
            b.setUint8(0, 0);
    ...
    function la() {
        ...
        0 != H && (null == fa && (fa = new ga(24,
            "#FFFFFF")), fa.setValue("Score: " + ~~(H / 100)), a = fa.render(), b = a.width, e.globalAlpha = .2, e.fillStyle = "#000000", e.fillRect(10, r - 10 - 24 - 10, b + 10, 34), e.globalAlpha = 1, e.drawImage(a, 15, r - 10 - 24 - 5));
        Xa();
        c = +new Date - c;
    ...
    function Ga() {
        v = null;
        if (null != w || 0 != z.length)if (null != w || ha) {
            v = document.createElement("canvas");
            var a = v.getContext("2d"), b = 60, b = null == w ? b + 24 * z.length : b + 180, c = Math.min(200, .3 * q) / 200;
            v.width = 200 * c;
            v.height = b * c;
            a.scale(c, c);
            a.globalAlpha = .4;
            ...
            if (null == w)for (a.font = "20px Ubuntu", b = 0; b < z.length; ++b)c = z[b].name || "An unnamed cell", ha || (c = "An unnamed cell"), -1 != E.indexOf(z[b].id) ? (l[0].name && (c = l[0].name), a.fillStyle = "#FFAAAA") : a.fillStyle =
                "#FFFFFF", c = b + 1 + ". " + c, a.fillText(c, 100 - a.measureText(c).width / 2, 70 + 24 * b); else for (b = c = 0; b < w.length; ++b)angEnd = c + w[b] * Math.PI * 2, a.fillStyle = Ya[b + 1], a.beginPath(), a.moveTo(100, 140), a.arc(100, 140, 80, c, angEnd, !1), a.fill(), c = angEnd
        }
    }
    ...
    var F = f.location.protocol, Pa = "https:" == F;
    if ("agar.io" != f.location.hostname && "localhost" != f.location.hostname && "10.10.2.13" != f.location.hostname)f.location = F + "//agar.io/"; else if (f.top != f)f.top.location = F + "//agar.io/"; else {
        var ja, e, A, q, r, L = null, m = null, s = 0, t = 0, E = [], l = [], y = {}, n = [], G = [], z = [], S = 0, T = 0, W = -1, X = -1, Va = 0, I = 0, D = null, ba = 0, ca = 0, da = 1E4, ea = 1E4, h = 1, u = null, La = !0, ha = !0, ua = !1, qa = !1, H = 0, sa = !1, Ma = !1, N = s = ~~((ba + da) / 2), O = t = ~~((ca + ea) / 2), P = 1, M = "", w = null, ia = !1, pa = !1, na = 0, oa = 0, $ = 0,
            aa = 0, Q = 0, Ya = ["#333333", "#FF3333", "#33FF33", "#3333FF"], C = 1, xa = "ontouchstart"in f && /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), ta = new Image;
        ta.src = "img/split.png";
        Q = document.createElement("canvas");
        if ("undefined" == typeof console || "undefined" == typeof DataView || "undefined" == typeof WebSocket || null == Q || null == Q.getContext || null == f.localStorage)alert("You browser does not support this game, we recommend you to use Firefox to play this"); else {
            var Y = null;
            ...
            g.get(F + "//gc.agar.io", function (a) {
                ...
                a = b[0];
                b = b[1] || "";
                -1 == "DE IL PL HU BR AT UA".split(" ").indexOf(a) && va.push("nazi");
            ...
            f.connect = Ea;
            var Z = 500, Ia = -1, Ja = -1, v = null, x = 1, fa = null, J = {}, va = "poland;usa;china;russia;canada;australia;spain;brazil;germany;ukraine;france;sweden;hitler;north korea;south korea;japan;united kingdom;earth;greece;latvia;lithuania;estonia;finland;norway;cia;maldivas;austria;nigeria;reddit;yaranaika;confederate;9gag;indiana;4chan;italy;bulgaria;tumblr;2ch.hk;hong kong;portugal;jamaica;german empire;mexico;sanik;switzerland;croatia;chile;indonesia;bangladesh;thailand;iran;iraq;peru;moon;botswana;bosnia;netherlands;european union;taiwan;pakistan;hungary;satanist;qing dynasty;matriarchy;patriarchy;feminism;ireland;texas;facepunch;prodota;cambodia;steam;piccolo;ea;india;kc;denmark;quebec;ayy lmao;sealand;bait;tsarist russia;origin;vinesauce;stalin;belgium;luxembourg;stussy;prussia;8ch;argentina;scotland;sir;romania;belarus;wojak;doge;nasa;byzantium;imperial japan;french kingdom;somalia;turkey;mars;pokerface;8;irs;receita federal".split(";"), Za = ["8", "nasa"], $a = ["m'blob"];
            Ha.prototype = {
                id: 0,
                points: null,
                pointsAcc: null,
                ...
                draw: function () {
                    if (this.shouldRender()) {
                        ...
                        if ((ha || b) && this.name && this.nameCache && (null == d || -1 == Za.indexOf(c))) {
                            ...
                            c = Math.ceil(10 * h) / 10;
                            d.setScale(c);
                            var d = d.render(), f = ~~(d.width / c), g = ~~(d.height / c);
            ...
            ga.prototype = {
                ...
                render: function () {
                    ...
                    if (this._dirty) {
                        ...
                        b.font = f;
                        var g = b.measureText(c).width, h = ~~(.2 * e);
                        a.width = (g + 6) * d;
                        a.height = (e + h) * d;
                        b.font = f;
                        b.scale(d, d);
    ...
    g(document).keypress(function(e){
	    if (e.keyCode == 99) {
		    var ip = prompt('Serverio IP:', typeof window.custom_ip == 'undefined' ? null : window.custom_ip);
		    if (ip == null)
		    	return;
	    	window.custom_ip = ip;
	    	//setRegion(localStorage.location == 'RU-Russia' ? 'EU-London' : 'RU-Russia');
	    	g('#region').change();
	    }
    });
})(window, jQuery);